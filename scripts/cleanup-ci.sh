	...
	do
		...
		then
			...
			destroy-cluster3 \
				...
				-CISInstanceCRN "${CIS_INSTANCE_CRN}" \
...
{"clusterName":"${CLUSTER_NAME}","clusterID":"","infraID":"${CLUSTER_NAME}","powervs":{"BaseDomain":"${BASEDOMAIN}","cisInstanceCRN":"${CIS_INSTANCE_CRN}","powerVSResourceGroup":"${RESOURCE_GROUP_ID}","region":"${POWERVS_REGION}","vpcRegion":"","zone":"${POWERVS_ZONE}","serviceInstanceID":"${SERVICE_INSTANCE_GUID}"}}
___EOF___
