...
require (
	...
	github.com/IBM-Cloud/power-go-client v1.0.88 // v1.0.75
	...
	github.com/ppc64le-cloud/pvsadm v0.1.3
)
...
require (
	...
	github.com/ppc64le-cloud/powervs-utils v0.0.0-20210415051532-4cdd6a79c8fa // indirect
